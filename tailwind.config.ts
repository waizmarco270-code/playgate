  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'rain-1': 'rain-1 6s linear infinite',
        'rain-2': 'rain-2 7s linear infinite',
        'rain-3': 'rain-3 8s linear infinite',
        'rain-4': 'rain-4 6.5s linear infinite',
        'rain-5': 'rain-5 7.5s linear infinite',
        'rain-6': 'rain-6 8.5s linear infinite',
        'rain-7': 'rain-7 6s linear infinite',
